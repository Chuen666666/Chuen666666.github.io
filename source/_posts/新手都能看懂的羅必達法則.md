...
1. 1. $\lim_{x \to 0} \frac{\sqrt{x}}{\sqrt{1+\sqrt{x}}-1}=\lim_{x \to 0} \frac{\cancel{\frac{1}{2}x^{-1/2}}}{\frac{1}{2}(1+\sqrt{x}) \cdot \cancel{\frac{1}{2}x^{-1/2}}}=\lim_{x \to 0} \frac{2}{1+\sqrt{x}}=2$
