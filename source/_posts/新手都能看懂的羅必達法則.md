---
title: 新手都能看懂的羅必達法則（L'Hôpital's rule）
...
## 例子
1. $\displaystyle \lim_{x \to 0} \frac{\sqrt{x}}{\sqrt{1+\sqrt{x}}-1} = \lim_{x \to 0} \frac{\cancel{\frac{1}{2}x^{-\frac{1}{2}}}}{\frac{1}{2}(1+\sqrt{x}) \cdot \cancel{\frac{1}{2}x^{-\frac{1}{2}}}} = \lim_{x \to 0} \frac{2}{1+\sqrt{x}} = 2$
2. $\displaystyle \lim_{x \to 1} \frac{\sin(x^2-1)}{x-1} = \lim_{x \to 1} \frac{\cos(x^2-1) \cdot 2x}{1} = 2$