...
2. 做法：分子、分母都微分一次
   - 若羅一次後仍不定形式，可再羅一次
## 例子
1. $\lim_{x\to0}\frac{\sqrt x}{\sqrt{1+\sqrt x}-1}=\lim_{x\to0}\frac{\sout{\frac12x^{-\frac12}}}{\frac12(1+\sqrt x)\cdot\sout{\frac12x^{-\frac12}}}=\lim_{x\to0}\frac{2}{1+\sqrt x}=2$
2. $\lim_{x\to1}=\frac{\sin(x^2-1)}{x-1}=\lim_{x\to1}\frac{\cos(x^2-1)\cdot2x}{1}=2$