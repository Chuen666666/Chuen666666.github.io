...
這次的比賽，主辦單位還特別在我們晚宴時做了一個小小的舉手調查，問了我們是否有人是純手刻不用 AI？結果完全不意外地，全員 Vibe Coding，但比賽一旦開放了 AI 的使用，意思就有點像大學的開書考，難度一定是低不了，AI 很顯然地降低了對於各種庫、API 接口、函式的學習成本，但不代表一個對 HPC 毫無了解的新手，可以在不進行任何學習的情況下，拿到比賽冠軍。這次比賽我就能很明顯感受到：一開始我對題目了解不足的情況下，連第一子題這種簡單題，都需要搞半天，後來隨著和 AI 協作多了，自然也學得多了，加上我對 HPC 也略有了解，才能在最後關頭把所有子題都拿下，並在報告時講出一套東西。

此外，這種難度和強度的比賽，也讓我非常強烈地感受到了不同 AI 模型的差距，
