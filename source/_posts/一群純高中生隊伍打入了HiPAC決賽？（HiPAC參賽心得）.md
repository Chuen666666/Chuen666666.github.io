...
此外，這種難度和強度的比賽，也讓我非常強烈地感受到了不同 AI 模型的差距，一開始我忘記選去 Opus 5 時，用了 Sonnet 5 一段時間，明顯能感覺到它在處理這種題目時的效率不如 Oups 5，之所以不用 Fabel 5，純粹只是怕 Token 提早燒了而已，否則用它來做題，效率應該會再更上一層樓。
...
另一個對國網的印象就是「闊綽」，無論是比賽設備、住宿、接駁車、晚宴，都看得出來國網下了血本，入住的第一天，我們就已經有了「能住到這種飯店，得不得獎的，反正已經賺了」的感覺；但另一方面，這次 HiPAC 也真的是出了一堆問題，例如 OJ 能下載到別人的 Submission、沒限外網連線又規則不明確等問題，不過最重要的是態度，尤其發現晚上能用 VPN 連進機器時，主動打電話卻無法得到一個明確的答案，反而更像在威脅我們，都令我感到有些不適。
